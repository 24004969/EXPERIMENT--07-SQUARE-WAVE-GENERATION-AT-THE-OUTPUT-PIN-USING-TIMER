...
![image](https://github.com/user-attachments/assets/972f9ee5-df22-4f88-b44a-0993ecd222a7)

  ## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 

![image](https://github.com/user-attachments/assets/44124d35-271e-41d1-8de4-dd3598db87fb)
...
DUTY CYCLE = TON /(TON+TOFF)
      ...
      IN % =0.5*100 
           = 50 %
```
![image](https://github.com/user-attachments/assets/cb523b53-ab07-4044-98f8-53dfd21a4c41)
...
DUTY CYCLE = TON /(TON+TOFF)
      ...
      IN % =0.7*100 
           = 70 %
```
![image](https://github.com/user-attachments/assets/c6ee2af2-5a95-4627-84e0-e5c4b82933f7)
```
TON = 1 x 50 x 10^-6
    = 0.00005
